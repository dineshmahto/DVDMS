...
import { getTransferListForApproval } from "../../../../store/ordermanagement/action";
...
const TransferApproval = () => {
  ...
  useEffect(() => {
    if (
      ...
      setTotalRows(transferApprovalListResponse?.data?.totalElements);
      setTableData(transferApprovalListResponse?.data?.content);
      setLoading(false);
    } else if (
      transferApprovalListResponse &&
