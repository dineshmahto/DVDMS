...
const AddNewDrug = ({ openAddNewAssetModal, handleOpenAddAssetModal }) => {
  const addNewDrugSchema = Yup.object().shape({
    ...
    specification: Yup.string().required("Decription is Required"),
  ...
  return (
    <>
      <BasicModal
        title="Create New Asset Record"
        show={openAddNewAssetModal}
        close={() => {
              ...
              <div className="row">
                <div className="col-10 offset-1">
                  <div className="row mb-2">
                    <div className="col-3">
                      <label for="assetName" class="col-form-label">
                        Asset Name :
                      </label>
                    </div>
                    <div className="col-9">
