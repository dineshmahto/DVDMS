            ...
            <div className="col-xl-3 col-md-6">
                <div className="card bg-primary text-white mb-4">
                    <div className="card-body">
                        <div className="inner">
                            <div className="text-total">2</div>
                            <p>Today's Indent</p>
                        </div>
                    </div>
